...
from .models import (
    Technician, Municipality, Family, Subsystem,
    FamilySubsystem, Project, TimelineEvent, Evento
)
...
class ProjectAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Informações Gerais', {
            'fields': ('nome_projeto', 'descricao', 'status')
        }),
        ('Datas e Orçamento', {
            'fields': (('data_inicio', 'data_fim'), 'orcamento')
        }),
    )
