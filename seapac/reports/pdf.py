...
def gerar_relatorio_family(family):
    ...
    story.append(Paragraph(
        f"Receita Total: R$ {renda['total_receita']:.2f}", styles["Normal"]
    ))
    story.append(Paragraph(
        f"Receita Potencial: R$ {renda['total_receita_potencial']:.2f}", styles["Normal"]
    ))
    story.append(Paragraph(
        f"Lucro Total: R$ {renda['renda_total']:.2f}", styles["Normal"]
    ))
    story.append(Paragraph(
        f"Lucro Potencial: R$ {renda['renda_total_potencial']:.2f}", styles["Normal"]
    ))
